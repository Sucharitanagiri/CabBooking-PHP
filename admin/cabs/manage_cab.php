		...
		<form action="" id="cab-form">
			...
			<div class="form-group col-md-6">
				...
				<div class="custom-file">
					<input type="file" class="custom-file-input rounded-circle" id="customFile" name="img" onchange="displayImg(this, $('#cimg'))">
			...
			<div class="form-group col-md-6">
				...
				<div class="custom-file">
					<input type="file" class="custom-file-input rounded-circle" id="customFile2" name="img1" onchange="displayImg(this, $('#cimg1'))">
					<label class="custom-file-label" for="customFile2">Choose file</label>
				</div>
			</div>
			<div class="form-group col-md-6 d-flex justify-content-center">
				<img src="<?php echo validate_image(isset($cab_image_path) ? $cab_image_path : "") ?>" alt="" id="cimg1" class="img-fluid img-thumbnail">
			</div>
...
<script>
  window.displayImg = function(input, targetImg) {
        if (input.files && input.files[0]) {
            var reader = new FileReader();
            reader.onload = function (e) {
                targetImg.attr('src', e.target.result);
                targetImg.siblings('.custom-file-label').html(input.files[0].name);
            }
            reader.readAsDataURL(input.files[0]);
        } else {
            targetImg.attr('src', "<?php echo validate_image(isset($image_path) ? $image_path : "") ?>");
            targetImg.siblings('.custom-file-label').html("Choose file");
        }
    }
