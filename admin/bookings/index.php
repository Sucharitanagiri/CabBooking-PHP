<div class="card card-outline card-purple shadow rounded-0">
    <div class="card-header">
        ...
        <a class="btn btn-flat btn-success btn-sm export_data" href="javascript:void(0)"><span class="fa fa-plus"></span> Export</a>
		</div>
    </div>
    <div class="card-body">
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <thead>
                    <tr class="bg-gradient-dark text-light">
                        ...
                        <th class="text-center">Booking Amount <br>(Per Km)</th>
...
<script>
    ...
    function export_data(){
		start_loader();
		$.ajax({
			url:_base_url_+"classes/Master.php?f=export_data",
			method:"POST",
			dataType:"json",
			error:err=>{
				console.log(err)
