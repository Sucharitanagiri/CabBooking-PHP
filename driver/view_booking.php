...
<div class="container-fluid">
    ...
    <div class="text-right">
        ...
        <button class="btn btn-primary btn-flat bg-gradient-danger" type="button" id="cancel_booking">Cancel Booking</button>
...
<script>
    $(function(){
        ...
        $('#pickup_booking').click(function(){
            _conf("Mark [Ref. Code: <b><?= isset($ref_code) ? $ref_code : "" ?></b>] booking as Picked Up?", "update_booking_status",["<?= isset($id) ? $id : "" ?>",3])
        }) 
        $('#dropoff_booking').click(function(){
            _conf("Mark [Ref. Code: <b><?= isset($ref_code) ? $ref_code : "" ?></b>] booking as Dropped Off?", "update_booking_status",["<?= isset($id) ? $id : "" ?>",4])
        })
