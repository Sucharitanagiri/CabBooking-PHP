            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                      <li class="nav-item"><a class="nav-link <?= isset($page) && $page == 'home'? "active" : '' ?>" aria-current="page" href="./?p=dashboard">Dashboard</a></li>
                        <li class="nav-item"><a class="nav-link <?= isset($page) && $page == 'home'? "active" : '' ?>" aria-current="page" href="./">Bookings</a></li>
                    </ul>
                    ...
                    <div class="d-flex align-items-end">
                      <div class="navbar-nav nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                          <a class="dropdown-item" href="./?p=manage_account">Profile</a>
                          <a class="dropdown-item" href="./?p=change_password">Change Password</a>
                          <a class="dropdown-item" href="./?p=cab_details">Update Cab Details</a>
